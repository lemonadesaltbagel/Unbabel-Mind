...
return(<div className="bg-white p-6 rounded-xl shadow w-full lg:w-1/2 h-[80vh] overflow-y-auto"><h2 className="text-xl font-bold mb-2">Reading Section</h2><h3 className="text-md font-semibold mb-4">{title}</h3><p className="whitespace-pre-wrap text-sm" onContextMenu={onContextMenu}>{rht(content,highlights)}</p></div>);} 