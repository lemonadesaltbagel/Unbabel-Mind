...
export default function CopyrightMessage({ 
  ...
  const handleGuideClick = () => window.open('/QUIZ_CREATION_GUIDE.html', '_blank');
      ...
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-xl p-8 text-center">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6">
          ...
          <p className="text-blue-700 mb-4">
            Due to copyright restrictions, we can not upload the questions to Github directly. 
            To access this content, please download the questions from ILES website yourself and add them to the system.
          </p>
        ...
        <div className="mt-6 pt-4 border-t border-gray-200">
          <p className="text-xs text-gray-500">
            This is the standard way to add new quizzes to the system. 
            Follow the guide to learn how to create and contribute your own quiz content.
          </p>
        </div>
      </div>
    </div>
