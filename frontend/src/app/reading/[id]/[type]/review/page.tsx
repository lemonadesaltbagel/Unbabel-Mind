          ...
          <div className="w-[500px] bg-white p-6 rounded-xl shadow overflow-y-auto h-[80vh] border-r border-gray-400">
            ...
            {showContextMenu && (
              ...
              >
                ...
                <button className="w-full px-4 py-2 text-left hover:bg-gray-100 text-sm" onClick={handleParaphrase}>AI Paraphrase</button>
              </div>
            )}
          </div>
            ...
            <div className="mt-8 pt-4 border-t border-gray-200">
              ...
              <div className="text-sm text-gray-600 space-y-2">
                ...
                <p className="font-medium">
                  Score: {Math.round(
                    (qs.filter(q => 'number' in q && a[q.number]?.[0] === q.correct).length /
                    qs.filter(q => 'number' in q).length) * 100
                  )}%
                </p>
