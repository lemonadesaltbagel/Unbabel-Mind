...
const loadConfigs=async()=>{try{const r=await fetch('/profile/configs');if(r.ok){const d=await r.json();setOpenaiToken(d.openaiToken||'');}}catch(e){console.error('Error loading configs:',e);}};
