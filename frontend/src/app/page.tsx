...
if(loading){return(<div className="min-h-screen bg-black flex items-center justify-center"><div className="text-white text-xl animate-pulse">Loading...</div></div>);}
return(
<div className="min-h-screen bg-black text-white overflow-hidden">
<div className="fixed inset-0 pointer-events-none">
<div className="absolute inset-0 bg-gradient-to-br from-purple-900/20 via-transparent to-blue-900/20"></div>
<div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(120,119,198,0.1),transparent_50%)]"></div>
<div className="absolute top-0 left-0 w-full h-full opacity-30" style={{backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%239C92AC' fill-opacity='0.05'%3E%3Ccircle cx='30' cy='30' r='1'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`}}></div>
</div>
...
<h1 className="relative text-6xl md:text-8xl font-black mb-6 bg-gradient-to-r from-purple-400 via-pink-500 via-red-500 via-yellow-500 via-green-500 via-blue-500 to-purple-600 bg-clip-text text-transparent bg-[length:200%_100%] animate-[flow_3s_ease-in-out_infinite] tracking-tight hover:scale-105 transition-transform duration-500">Unbabel Mind</h1>
</div>
<p className="text-xl md:text-3xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed font-light animate-fade-in-up">Master language comprehension with interactive passages and real-time feedback</p>
...
<div className="absolute -bottom-20 -right-20 w-40 h-40 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full blur-3xl opacity-20 animate-float" style={{animationDelay: '2s'}}></div>
<div className="absolute top-1/2 -right-10 w-20 h-20 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-full blur-2xl opacity-30 animate-float" style={{animationDelay: '4s'}}></div>
</div>
<div className="flex gap-6 justify-center flex-wrap mb-16">
<Link href="/login" className="group relative overflow-hidden bg-gradient-to-r from-purple-500 to-blue-500 text-white px-10 py-4 rounded-2xl font-bold text-lg hover:from-purple-600 hover:to-blue-600 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25">
<span className="relative z-10">Sign In</span>
<div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
</Link>
<Link href="/signup" className="group relative overflow-hidden border-2 border-white/30 text-white px-10 py-4 rounded-2xl font-bold text-lg backdrop-blur-sm bg-white/5 hover:bg-white/10 hover:border-white/50 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-white/25">
...
<h2 className="relative text-6xl font-black mb-6 bg-gradient-to-r from-purple-400 via-pink-500 to-blue-400 bg-clip-text text-transparent tracking-tight">Interactive Demo</h2>
</div>
<p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">Experience our AI-powered learning platform with cutting-edge technology</p>
</div>
<div className="relative">
...
{['Reading','Listening','Speaking','Writing'].map((tab)=>(<button key={tab} onClick={()=>setActiveTab(tab)} className={`group relative overflow-hidden px-8 py-8 rounded-2xl font-bold transition-all duration-500 text-left flex-shrink-0 text-lg ${activeTab===tab?'bg-gradient-to-r from-purple-500 to-blue-500 text-white shadow-2xl shadow-purple-500/25 transform scale-105':'bg-transparent text-gray-400 hover:text-white hover:bg-white/10'}`}>
<span className="relative z-10">{tab}</span>
{activeTab===tab&&<div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>}
</button>))}
</div>
</div>
...
<div className="text-sm text-gray-300 mb-3">There are other parrots that share the kakapo&apos;s inability to fly.</div>
...
<button className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300 transform hover:scale-105">⏮️</button>
<button className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 py-2 rounded-lg text-sm font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg">▶️ Play</button>
<button className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300 transform hover:scale-105">⏭️</button>
</div>
...
<h2 className="relative text-5xl font-black mb-8 bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent tracking-tight">Real-Time AI Feedback</h2>
</div>
<p className="text-xl text-gray-300 mb-8 leading-relaxed">Get instant feedback on your answers with our advanced AI system. Understand your mistakes, learn from them, and track your progress over time.</p>
...
<h2 className="relative text-6xl font-black mb-8 bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent tracking-tight">Comprehensive IELTS Preparation</h2>
</div>
...
<p className="text-gray-300 text-sm leading-relaxed">Interactive passages with highlighting, note-taking, and multiple question types including True/False/Not Given, Multiple Choice, and Fill-in-the-blank</p>
</div>
</div>
<div className="group relative">
...
<p className="text-gray-300 text-sm leading-relaxed">Audio transcript synchronization with interactive questions, real-time scoring, and Cambridge IELTS materials</p>
</div>
</div>
<div className="group relative">
...
<p className="text-gray-300 text-sm leading-relaxed">AI-powered speaking prompts with voice recording capabilities and structured IELTS-style practice</p>
</div>
</div>
<div className="group relative">
...
<p className="text-gray-300 text-sm leading-relaxed">Rich text editor with word count, auto-save, and comprehensive writing task types for Task 1 & Task 2</p>
</div>
</div>
</div>
</div>
...
<h2 className="relative text-5xl font-black mb-8 bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent tracking-tight">Advanced AI Quiz System</h2>
</div>
<p className="text-xl text-gray-300 mb-8 leading-relaxed">Our dynamic AI generates personalized questions across three categories to adapt to your learning level and provide targeted practice.</p>
<div className="space-y-6">
<div className="flex items-center space-x-4 group">
...
<div className="relative mb-16">
<div className="absolute -inset-8 bg-gradient-to-r from-yellow-600 to-orange-600 rounded-full blur-3xl opacity-30 animate-pulse"></div>
<h2 className="relative text-6xl font-black mb-8 bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent tracking-tight">Why Choose Unbabel Mind?</h2>
</div>
...
<p className="text-gray-300 leading-relaxed">Accelerate your language learning with targeted exercises and immediate feedback</p>
</div>
</div>
<div className="group relative">
<div className="absolute -inset-4 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl blur-2xl opacity-0 group-hover:opacity-50 transition-opacity duration-500"></div>
...
<p className="text-gray-300 leading-relaxed">Enjoy a modern, intuitive design that makes learning engaging and enjoyable</p>
</div>
</div>
<div className="group relative">
<div className="absolute -inset-4 bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl blur-2xl opacity-0 group-hover:opacity-50 transition-opacity duration-500"></div>
...
<p className="text-gray-300 leading-relaxed">Monitor your improvement with detailed analytics and performance insights</p>
</div>
</div>
</div>
</div>
...
<p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">Join thousands of learners who have already improved their language skills with Unbabel Mind</p>
<div className="flex gap-6 justify-center flex-wrap">
<Link href="/signup" className="group relative overflow-hidden bg-gradient-to-r from-purple-500 to-blue-500 text-white px-12 py-4 rounded-2xl font-bold text-lg hover:from-purple-600 hover:to-blue-600 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25">
<span className="relative z-10">Get Started Free</span>
<div className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
</Link>
<Link href="/login" className="group relative overflow-hidden border-2 border-white/30 text-white px-12 py-4 rounded-2xl font-bold text-lg backdrop-blur-sm bg-white/5 hover:bg-white/10 hover:border-white/50 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-white/25">
<span className="relative z-10">Sign In</span>
<div className="absolute inset-0 bg-gradient-to-r from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
</Link>
</div>
