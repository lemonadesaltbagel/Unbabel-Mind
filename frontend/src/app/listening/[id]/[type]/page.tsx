...
const hn=(d:'back'|'next')=>{if(d==='back'){r.push('/dashboard?tab=Listening');}else{const nt=qt+1;if(nt>=1&&nt<=4)r.push(`/listening/${id}/${nt}`);}};
